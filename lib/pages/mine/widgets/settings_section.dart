      ...
      children: [
        ...
        _buildSectionContainer([
          ...
          _buildListItem(
              ...
              title: '货币与数字格式化',
              onTap: () => context.push('/mine/day45_number_format_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              ...
              title: '相对时间显示',
              onTap: () => context.push('/mine/day46_timeago_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.security,
              title: '加密基础与哈希散列',
              onTap: () => context.push('/mine/day47_crypto_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              ...
              title: 'UUID与对称加密',
              onTap: () => context.push('/mine/day48_uuid_encrypt_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              ...
              title: '多类型文件选择',
              onTap: () => context.push('/mine/day49_file_picker_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              ...
              title: '路径与文件系统',
              onTap: () => context.push('/mine/day50_path_provider_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.play_circle_outline,
              title: '基础视频播放 (video_player)',
              onTap: () => context.push('/mine/day51_video_player_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              ...
              title: '增强全屏内核 (chewie)',
              onTap: () => context.push('/mine/day52_chewie_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.camera,
              title: '组件截图成图 (screenshot)',
              onTap: () => context.push('/mine/day53_screenshot_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              ...
              title: '相册保存与第三方分享',
              onTap: () => context.push('/mine/day54_share_save_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              ...
              title: '版本信息与外部跳转',
              onTap: () => context.push('/mine/day55_app_info_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
          ...
          _buildListItem(
              ...
              title: '启动优化与原生启动屏',
              onTap: () => context.push('/mine/day58_splash_optimization_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.keyboard,
              title: '键盘体验与输入优化',
              onTap: () => context.push('/mine/day59_keyboard_visibility_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              ...
              title: 'Logger 日志美化',
              onTap: () => context.push('/mine/day60_logger_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              ...
              title: '环境变量管理 (Dotenv)',
              onTap: () => context.push('/mine/day61_dotenv_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.http,
              title: '网络日志美化 (Dio)',
              onTap: () => context.push('/mine/day62_pretty_dio_logger_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.monitor_heart_outlined,
              title: 'Sentry 崩溃与性能监控',
              onTap: () => context.push('/mine/day63_sentry_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.movie_outlined,
              title: 'Day 66: Lottie 动画基础',
              onTap: () => context.push('/mine/day66_lottie_basic_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.movie_filter_outlined,
              title: 'Day 67: Lottie 进阶控制',
              onTap: () => context.push('/mine/day67_lottie_advanced_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.face_retouching_natural,
              title: 'Day 68: 趣味交互：捂眼登录',
              onTap: () => context.push('/mine/day68_lottie_interactive_login'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.auto_awesome_mosaic_outlined,
              title: 'Day 69: 自动骨架屏 (Skeletonizer)',
              onTap: () => context.push('/mine/day69_skeletonizer_demo'),
              showBorder: true,
              isDark: isDark),
          _buildListItem(
              context: context,
              icon: Icons.bolt,
              title: 'Day 71: 启动性能深度优化',
              onTap: () =>
                  context.push('/mine/day71_performance_optimization'),
              showBorder: false,
              isDark: isDark),
        ], isDark),
      ],
